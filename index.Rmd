...
data_opioid %>% 
  ...
  geom_line(size= 2) +
  geom_point(size = 4) + 
  labs(x = NULL, y = "Opioid-Related Overdose Mortality Rate", title = "Opioid-use Related Mortality Rates Over Time", subtitle = "Data from Colombus, OH: 2010-2016", caption = "Rates are age-adjusted per 100,000 people.") + 
  theme_minimal() + 
