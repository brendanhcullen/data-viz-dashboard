...
[![](bchc_logo_big.png)](http://www.bigcitieshealth.org/city-data)
</center>
...
[![](cities_map.png)](http://www.bigcitieshealth.org/our-members-big-cities-health-coalition-bchc/)
</center>
...
This plot represents average obesity rates for adults (18 years and over) across all years in the dataset (2010-2018) for each city. In general, obesity is defined as Body Mass Index (BMI) of 30 or greater. This plot includes data for all races and genders. The average obesity rate for the entire U.S. is represented by the black bar.     
