...
obesity_hdmr %>% 
  ...
  labs(x = "Percent Obese", y = "Heart Disease Mortality Rate", title = "Relationship between Obesity and Heart Disease", caption = "3 most/least obese states are labeled and colored red/blue, respectively.\nHeart Disease Mortality Rate age adjusted; per 100,000 people.")
```
